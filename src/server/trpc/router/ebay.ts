    ...
    .mutation(async ({ ctx, input }) => {
      ...
      try {
        ...
        const createOffer = await ebay.sell.inventory.createOffer({
          ...
          listingDescription: `<h1>Parted Euro</h1><h2> Product Description: </h2><p> ${input.description} </p><h3> Fitment: </h3><p> *Port fitments from Website for each part* </p><p> Please note: It is the <b> <u> BUYERS REPSONSIBILITY </b> </u>  to ensure fitment is correct for their vehicle. If you are unsure, feel free to send us a message and we will do our best to assist. </p><p> <b> Refunds will not be issued </b> if the part is not suitable for your car.  </p><h3> Payment: </h3><p> We only accept PayPal for sales via eBay that are being shipped. For in-store pickup, we can also accept Card (2.5% surcharge) or Cash. Please ensure you have selected the correct delivery method at checkout. </p><h3> Shipping: </h3><p> Any item(s) purchased will be shipped within <b> 2-3 business days </b> of the sale, once payment has been received. </p><h3> Warranty / Returns: </h3><p> We offer a 30-Day return policy, if an item fails or is not in the expected condition. <b> </p>
<p> Unfortunately due to safety concerns, all items that are airbag / brake / hydraulic related are exempt from this warranty, as we cannot ensure the longevity of these second hand parts. Buy at your own risk. </b> We aim to be as transparent as possible with the condition of second hand parts. </p><p> Refunds will not be issued for change of mind. </p><h3> About Us: </h3><p> We are a small wrecking business located in Knoxfield, Victoria (Australia). We ship worldwide, or offer in-store pickup. </p><p> If you are chasing something that is not listed on eBay, please visit our website <b><a href="https://www.partedeuro.com.au/" target="_blank"> https://www.partedeuro.com.au/</a> </b> or send us an email at <b> contact@partedeuro.com.au </b> and we will do our best to assist. </p>`,
          listingPolicies: {
