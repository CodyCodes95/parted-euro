...
const GenerationMenu:React.FC<GenerationMenuProps> = ({setExpanded, linkRef}) => {
  ...
  return (
    ...
    >
      <div className="2xl:ml-20 2xl:mr-20 grid w-full grid-cols-6  gap-x-16 gap-y-8 2xl:px-8 2xl:py-8 px-4">
        <div className="flex flex-col">
          <h4>F8X - M2/M3/M4</h4>
          <Link
            className="py-2 2xl:py-3 text-sm text-[#4d4d4d] hover:underline"
            href={""}
          >
            All F8X Parts
          </Link>
