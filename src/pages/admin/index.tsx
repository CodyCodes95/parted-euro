...
const Admin: NextPage = () => {
  ...
  useEffect(() => {
    if (code) {
      renewToken.mutateAsync({ code: window.location.href })
      ...
      <main className="flex min-h-screen w-full flex-col items-center justify-center">
        ...
        <div className="flex w-[25%] items-center justify-around">
          ...
          <div className="flex flex-col items-center">
            <p className="text-xl">{daysTillExpiry.data?.daysTillExpiry} Days until Xero expiry.</p>
          <div className="p-2"></div>
            <button className="hover:underline" onClick={onRenew} >Renew token</button>
          </div>
        </div>
      </main>
    </>
