    ...
    return (
      <div className="flex w-full flex-col items-center px-96">
        <div className="flex w-[75%] flex-col">
          ...
          <BoldPara>
            Any <span className="underline">USED</span> item that is related to{" "}
            <span className="underline">Brakes, Hydraulics or Electronics are EXCLUDED</span> from all
            warranties.
          </BoldPara>
          <Paragraph>
            ...
            description of their condition, whether they were in good & working
            order, or if condition was not known. Prices will reflect this.
            Buyer agrees to these terms by purchasing any brake and hydraulic
            related item.
          </Paragraph>
          <Paragraph>
            Electronic components can potentially appear faulty, or be damaged
            upon install due to other external sources interfering, if problems
            are incorrectly diagnosed. For this reason, we cannot offer warranty
            on any electrical products. All electronic used items will have a
            detailed description of their condition, whether they were in a good
            & working order, or if condition was not known. If applicable,
            photos of the electronic item will be shown for items. Buyer agrees
          ...
          <ListPara>
            ...
            mentioned / highlighted in the listing.
          </ListPara>
          <ListPara>
            The part(s) supplied are not as described, or does not suit the part
            number / VIN that we have listed. Note: This does not apply if you
            are trying to retrofit parts to a different car. This is only
            applicable if the part does not suit car(s) that we have noted it is
            suitable for.
          </ListPara>
          <BoldPara>
          ...
          <ListPara>
            The part(s) have been opened, modified or tampered with in any way,
            shape or form.
          </ListPara>
          <ListPara>
